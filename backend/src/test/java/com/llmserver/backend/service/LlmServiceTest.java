...
@TestPropertySource(properties = {
    "llm.api.path=/v1beta/models/gemma-3-4b-it:generateContent?"
})
class LlmServiceTest {
    ...
    void shouldReturnLlmResponseSuccessfully() {
        ...
        wireMockServer.stubFor(post(urlPathEqualTo("/v1beta/models/gemma-3-4b-it:generateContent"))
        ...
        wireMockServer.verify(postRequestedFor(urlEqualTo("/v1beta/models/gemma-3-4b-it:generateContent"))
